#let bg() = {
  rect(width: 95%, height: 95%, inset: 10pt, radius: 5pt, stroke: (paint: red, thickness: 2pt),
    rect(width: 100%, height: 100%, outset: 0pt,  radius: 5pt, stroke: (paint: red, thickness: 2pt))
  )
}
