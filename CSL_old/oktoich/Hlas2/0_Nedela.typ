...
#let P = (
  ...
  "9": (
    ...
    ("", "", "Íže v molítvach bódruju, čístuju Bohoródicu, prizyvájem vsí boľízniju i skórbiju oderžími, vzyvájušče: Vladýčice čístaja, skóro izbávi ot oderžáščich boľíznej rabý tvojá prísno, jáko po Bóze zastúpnicy inýja ne ímamy."),
  ...
  "K": (
    ...
    "P3": (
      ...
      "2": (
        ...
        ("", "", "Íže vsích výšši Christós, umálisja málym čím, strástiju plotskóju, ánheľskaho jestestvá."),
        ("", "", "Mértv so bezzakónnymi vminívsja, sijája ženám vincém slávy Christé, javílsja jesí ot voskrésnija."),
      ),
      "3": (
        ("", "", "Lúk sokrušísja síľnych deržávoju tvojéju Christé, i síloju nemoščstvújuščiji prepojásašasja."),
        ("", "", "Íže vrémene prevýššij vsjákaho, jáko vrémenem tvoréc, iz tebé Ďívo vóleju mladénec sozdásja."),
    ...
    "P9": (
      ...
      "2": (
        ...
        ("", "", "Íže svojéju smértiju, smérti deržávu síloju uprazdnívšemu Bóhu vsí vírniji poklonímsja, jáko íže ot víka mértvyja sovoskresí, i vsím podajét živót i voskresénije."),
      ),
      "3": (
