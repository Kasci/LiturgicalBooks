...
#let P = (
  "1": (
    ...
    ("","","Íže Bohoródicu ťá propovídujet prečístaja, na vsjákija jéresi pobiždénije nósit: plóť úbo bývšaho neizmínno porodilá jesi Bohorodíteľnice, výšša vsjákija tvári, Slóvo Bóžije prisnosúščnoje."),
  ),
  "3": (
  ...
  "6": (
    ...
    ("","","Íže vsederžávnoju síloju nosjáj vsjáčeskaja, v nemožénije plotskóje ot tebé oblečésja Ďívo vseneporóčnaja, vo blahoďijánije čelovíkov, jáko čelovikoľúbec."),
  ...
  "9": (
    ...
    ("","","Pobiždájuščuju jéresi júnošskija, čéstnúju cérkov pokaží, júže Christós Sýn tvój obrádovannaja, króviju čéstnóju svojéju jáko bláh sťažá, i spasé ot bíd i ot nasílija oderžáščaho nás, Vladýčice."),
  ),
)
  ...
  "K": (
    "P1": (
      "1": (
        ...
        ("","","Líče apóstoľskij svitovídnyj, svítu velíkomu predstojáj, mojé omračénoje ozarí sérdce, i ko spasíteľnym stezjám nastávi."),
        ("","","Ískrenniji drúzi izbáviteľa, strastéj mjá ľubvé izbávite, mnóhimi lesťmí žitijá preľščénaho, i nerazúmija nóščiju pokryvájemaho."),
      ...
      "2": (
        ...
        ("","","Íže tobóju predstátelem oboháščšijisja Nikólaje, vo dní že i v noščí víroju tebí vzyvájem: nýňi predvarí ny veľmí bídstvujuščyja bisóvskimi lukávymi navíty, i tletvórnych čelovík: jáko da tišinú polučívše, voschvaľájem ťá."),
    ...
    "P4": (
      ...
      "2": (
        ...
        ("","","Íže trí júnoši izbavléj, ótče Nikólaje, umréti choťáščyja, vsjákija mjá izbávi ťisnotý, i víčnaho osuždénija."),
    ...
    "P6": (
      "1": (
        ...
        ("","","Sotrjásše molítv prizyvánijem, nizložíste chrámy ídoľskija, učenicý Christóvy. no moľúsja víroju: umá mojehó sokrušíte ídoly, i pokažíte chrám Bóžij mnóhimi hrichí povínnaho."),
        ("","","Íže na kámeni nepokolebímim sozdávšesja, jáko kámenije, izbránniji bohovídcy, mojé sérdce v pescí umovrédno sozdánnoje spasíte: stekájutsja bo napástej ríki, i ľúťi mjá oburevájut."),
    ...
    "P8": (
      ...
      "2": (
        ...
        ("","","Íže vojevódy trí izbavléj ot smérti, prišéstvijem strášnym tvojím, svjaščennotaínniče Nikólaje, ot vsjákaho smertonósnaho vréda i nás izbávi."),
