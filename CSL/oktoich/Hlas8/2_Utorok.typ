#let V = (
  "HV": (
    ...
    ("","O preslávnaho čudesé!","Blažénne Joánne Predtéče, smirénnuju mojú dúšu, jáže ko Hóspodu ľubóviju vozvraščáj vsehdá, svjaščénnymi chodátajstvy tvojími slastéj mojích óhň uhasí, privoďá mja ko ispolnéniju božéstvennych poveľínij, i sérdca mojehó očiščája voístinnu čúvstvija, da slávľu ťá."),
...
#let P = (
  "1": (
    ...
    ("","","Íže vsjú tvár soderžáj i nosjáj i spasájaj, na rukú tvojéju čístaja opísan javísja, i čelovíčeskij ród obnoví."),
  ),
  "3": (
  ...
  "K": (
    ...
    "P5": (
      "1": (
        ...
        ("","","Íže bludnícu očístivyj, i prokažénnyja, tvojím poveľínijem soďíteľu vsjáčeskich, skvérnaho hrichá smirénnuju dúšu mojú očísti, i odéždami blistájuščimi krasnú soďílaj Vladýko, moľúsja."),
    ...
    "P7": (
      ...
      "2": (
        ...
        ("","","Íže putí Hospódni uhotóvavyj predtéče, k tomúže isprávi i mojá stezí, da zovú: blahoslovén jesí Bóže otéc nášich."),
