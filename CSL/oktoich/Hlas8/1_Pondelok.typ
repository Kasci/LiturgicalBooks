...
#let P_Po = (
  "1": (
    ...
    ("","","Ánhel mólit ťá, Hóspodi, mnóžestvo vsehdá: učenik sobór, i prorók, soslóvija múčenik, i prepodóbnych tvojích: Bohoródicy rádi hrichóv proščénije dáruj nám, jáko čelovikoľúbec."),
  ...
  "5": (
    ...
    ("","","Íže króv svojú Slóve, na kresťí prolijávyj, za premnóhuju mílosti bézdnu, strastéj mojích bézdnu izsuší: i vo umiléniji tebí Bóhu uhodíti, Bohoródicy rádi spodóbi."),
...
#let U_Po = (
  ...
  "S3": (
    ("","Poveľínnoje","Dokóľi, dušé mojá, živéši v neraďíniji? Dokóľi vo unýniji skončaváješi? Ot sná unýnija vostáni okajánnaja, vo úm prijémši ďijánija tvojá: vozstení, i právednaho sudijí vostrepeščí izrečénija, čtó otviščáti ímaši v čás ón? Ilí káko ožidájuščaho ťá izbávišisja opalénija, neisprávlena prebyvájušči? Vozopíj préžde koncá k sudijí: prehrišénij dážď mí, Spáse, ostavlénije, tý bo jedín jesí dolhoterpilív."),
  ...
  "K": (
    ...
    "P7": (
      "1": (
        ...
        ("Bohoródičen","","Íže Bóžije Bóh Slóvo, vo utróbu tvojú vséľsja, Ďívo Máti čístaja, vsím zastúpnicu obídimym javľájet ťá, vopijúščym: otéc nášich Bóže blahoslovén jesí."),
      ),
      "2": (
        ("","","Ot Judéji došédše ótrocy, v Vavilóňi inohdá, víroju Tróičeskoju plámeň péščnyj popráša pojúšče: otcév Bóže blahoslovén jesí."),
