  ...
  "K": (
    ...
    "P6": (
      ...
      "2": (
        ...
        ("","","Íže jestestvóm soďíteľ, soďíteľstvujetsja v ložesnách tvojích, pólnyj jáko Bóh, istoščavájetsja vseneporóčnaja: jedín bezsmértnyj, za vsích spasénije umirájet smértiju."),
      ),
    ),
    "K": (
