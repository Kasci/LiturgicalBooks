...
#let P = (
  ...
  "3": (
    ...
    ("","","Íže tobóju izbávľšesja ot bíd, i tebé rádi rádosť polučívše, Máti beznevístnaja, jáko podáteľnicu blahúju, i zastúpnicu blahochváľnu vsí proslavľájem."),
...
#let N = (
  ...
  "3": (
    ("","","V načáľi nebesá, vsesíľnym slóvom tvojím utverždéj Hóspodi Spáse, i vseďíteľnym i Bóžijim Dúchom vsjú sílu ích: na nedvížimim mjá kámeni ispovídanija tvojehó utverdí."),
    ("","","Íže jedínstvennaho i trisijánnaho, i vseďíteľnaho ťá Vladýku vospivájušče, hrichóv i iskušénij prósim izbavlénija bezmirnosíľnyj Bóže: da ne úbo prézriši, víroju tvojú bláhosť slávjaščich."),
  ...
  "S1": (
    ("","Íže mené rádi","Sohrišívšyja pomíluj Tróice svjatája, rabý tvojá: i prijimí kájuščyjasja tebí blahoutróbne, i proščénija spodóbi."),
...
#let U = (
  ...
  "Y": (
    ("","","Íže náš zrák vosprijémyj, i preterpívyj krest plótski, spasí mja voskresénijem tvojím Christé Bóže, jáko čelovikoľúbec."),
  ),
  "A1": (
  ...
  "K": (
    "P1": (
      "1": (
        ...
        ("","","Ád tebí priblížisja, i zubý ne vozmóh stérti ťílo tvojé, čeľusťmí sokrušísja. Otňúduže Spáse, boľízni razrúš smértnyja, voskrésl jesí tridnéven."),
    ...
    "P3": (
      ...
      "2": (
        ...
        ("","","Íže na kresťí strásti preterpívyj, i razbójniku ráj otvérzyj, jáko blahoďíteľ i Bóh, utverdí mój úm v vóľu tvojú, jedíne čelovikoľúbče."),
    ...
    "P6": (
      ...
      "3": (
        ...
        ("","","Íže choťínijem božéstvennym, soďíteľnoju že síloju vsé sostavléj ot ne súščich, iz čréva tvojehó čístaja, proizýde, i súščyja vo ťmí smértňij, Bohonačáľňijšimi mólnijami osijá."),
      ),
    ),
    "K": (
    ...
    "P7": (
      ...
      "2": (
        ...
        ("","","Íže na drévi krestňim hrichóvnoje žálo pritupív, i Adámova prestuplénija rukopisánije razrušív kopijém rebrá tvojehó, blahoslovén jesí Hóspodi Bóže otéc nášich."),
        ("","","Íže v rebró probodén býv, i kropléňmi króve božéstvennyja zémľu očístiv, krovmí idolobísija oskvernénnuju, blahoslovén jesí Hóspodi Bóže otéc nášich."),
    ...
    "P9": (
      "1": (
        ...
        ("","","Íže božestvú strásť prilahájuščiji, zaustítesja vsí čuždemúdrenniji: Hóspoda bo slávy plótiju raspjáta, ne raspjáta že jestestvóm božéstvennym, jáko vo dvojú jestestvú jedínaho veličájem."),
        ("","","Íže ťilesém vostániju nevírujuščiji, ko Christóvu šédše hróbu, naučítesja: jáko umerščvléna býsť, i voskrése páki plóť žiznodávca, vo uvirénije posľídňaho voskresénija, na néže upovájem."),
