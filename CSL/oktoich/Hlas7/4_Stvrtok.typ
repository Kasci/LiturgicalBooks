#let V = (
  "HV": (
    ...
    ("","","Íže víroju i ľubóviju vsjá prizyvájuščyja, i pojúščyja ťá vseblažénne svjatíteľu Nikólaje, izbávi pečálej."),
...
#let P = (
  ...
  "4": (
    ...
    ("","","Jáko mýslennuju ľístvicu čístaja, postavléj ťá súščym na zemlí Christós Bóh, tobóju k nebésnym božéstvennym ďijánijem vírnyja vozvódit, jáko milosérd."),
  ...
  "K": (
    "P1": (
      ...
      "2": (
        ...
        ("Bohoródičen","","Íže neveščéstvennyja sluhí sotvorív, iz tebé Bohoródice, rodísja za mílosť neizrečénnuju, čelovíki vídim býsť."),
      ),
    ),
    "P3": (
      "1": (
    ...
    "P4": (
      "1": (
        ("","","Íže Otcú soprestóľnyj Sýn, na zemlí voplóščsja jáko čelovík, izbrá vás učenikí, jehó Božestvó propovídati vsím jazýkom."),
        ("","","Íže Otcú soprestóľnyj Sýn, na zemlí voplóščsja jáko čelovík, izbrá vás učenikí, jehó Božestvó propovídati vsím jazýkom."),
    ...
    "P6": (
      "1": (
        ...
        ("","","Sámyja múdrosti božéstvenniji učenicý bývše, jéllinskuju obujíša premúdrosť, i mudrecá zlóby pohubíša: i v nevíďiniji bluďáščyja, svítom blahočéstija premúdriji prosvitíša."),
        ("","","Íže Petróvo drévle slezámi prehrišénije očístiv, tohó molítvami duší mojejá neisčétnaja sohrišénija očísti, bezmírnaho rádi tvojehó blahoutróbija i premnóhija, Christé, blahostýni."),
        ("","","Íže Ninevíťany drévle pokájavšyjasja uščédriv, i mené obýčnym tvojím milosérdijem pomíluj, apóstol tvojích rádi: i da ne za mnóžestvo prehrišénij izbáviteľu, mnóžestvo priložíši mučénija."),
