...
#let U = (
  ...
  "S2": (
    ...
    ("","","Íže bludnícy slézy, i Petrá prijémyj, i mytarjá opravdávyj iz hlubiný vozdochnúvša: i mené otčájannaho ot ďíl uščédri Spáse, i spasí mja."),
  ...
  "K": (
    ...
    "P3": (
      "1": (
        ...
        ("","","Íže prezirájaj čelovíkov hrichí, mnóhaho rádi Christé, čelovikoľúbija, prézri jedíne Spáse, mnóhaja mojá zlája: da ťá slávľu preblaháho."),
    ...
    "P8": (
      "1": (
        ...
        ("Múčeničen","","Vodámi božéstvennymi strastotérpcy spásovy navodňájemi prísno, napojájete vsjú zémľu podražánijem pódvihov vášich: i plodonósnu sijú dobroďíteľmi soďílovajete o Chrisťí vo víki."),
