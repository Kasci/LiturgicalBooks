...
#let P = (
  ...
  "3": (
    ...
    ("", "", "Íže jáko na runó doždém božéstvennym, vo utróbu tvojú sošédšim, oplamenénnoje ohném strastéj mojé sérdce orosí tvojími moľbámi."),
	),
  "4": (
    ...
    ("", "", "Íže ot konéc hór svjatých vsích, chrám Bóhu bývši jákože préžde prorók rečé: Christú číst pokaží mja chrám Vladýčice, tvojími zastupléňmi."),
	),
  "5": (
  ...
  "K": (
    "P1": (
      "1": (
        ...
        ("", "", "Íže slóvom bezslovésije razrišívše jazýkov apóstoli, ot bezslovésnych ďijánij ľúťi omračénoje sérdce mojé, uťíšiteľa blahodátiju , prosvitíte apóstoli."),
    ...
    "P3": (
      "1": (
        ...
        ("", "", "Hrád tvój Bóže, slovésnych rík tvojích tečénija učeník Vladýko, svjaščénno vozveseľájut."),
        ("", "", "Hrád tvój Bóže, slovésnych rík tvojích tečénija učeník Vladýko, svjaščénno vozveseľájut."),
    ...
    "P6": (
      ...
      "2": (
        ...
        ("", "", "Íže drévle umréti neprávedno imúščiji vojevódy, izbávišasja tvojími predstáteľstvy: jákože ťích, i nás ischití vsjákaho vréda, dostočúdne."),
    ...
    "P8": (
      ...
      "2": (
        ...
        ("", "", "Íže pobídy tezoimenít svjáte, pobidítelej nás pokaží, molítvami tvojími, strastém raždájuščym smérť, i prebezzakónnych čelovík jazýka ľstíva, vírno prísno moľáščichsja tí."),
