...
#let P_Sr = (
  ...
  "3": (
    ...
    ("","","Íže vsejá zemlí hórstiju soderžáj koncý, káko Máternimi ňídrami objémletsja? Mlekóm že pitájetsja ot soséc, nasyščája vsjáko živótno blahovolénija: i bohátyj izlijánijem obniščavájet voploščájem."),
  ),
  "4": (
  ...
  "5": (
    ...
    ("","","Íže pervonačáľnaho v ľíto poróždši, vo opísanňij plóti, voístinnu jestestvóm neopísannaho: tohó molí neprestánno o rabích tvojích."),
  ...
  "7": (
    ...
    ("","","Íže blahích ďílateľa Bóha nám róždšaja, tohó umolí máternimi moľbámi čístaja, uščédriti o tebí chváľaščichsja."),
