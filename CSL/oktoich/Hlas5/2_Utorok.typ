#let V_Ut = (
  "HV": (
    ...
    ("","Rádujsja","Vsehó preklónšasja v zémľu, i sokrušívšasja neiscíľno uvračúj predtéče Christóv i múčeniče, pribihájuščaho víroju v božéstvennyj pokróv tvój, blažénne: ťímže i dné strášnaho mjá ischití, vóňže choščú pred sudíščem státi, i múkam otdátisja, moľúsja tí, támošnaho stojánija izbávi mjá tohdá, jáko imýj derznovénije nepostýdno múdre, moľá podajúščaho mírovi véliju mílosť."),
...
#let P_Ut = (
  ...
  "8": (
    ...
    ("","","Íže volíteľa róždšaja mílosti, pomíluj vsích víroju pojúščich: vsjá ďilá Hospódňa Hóspoda pójte, i prevoznosíte jehó vo víki."),
...
#let U_Ut = (
  ...
  "S3": (
    ("","Sobeznačálnoje Slóvo","Vo hlubinú mja hrichá popólzšasja, trevolnénije oburevájet otčájanija: no predvarí Christé, jáko vsesílen, upráviteľu vsích, i ko pristánišču tíchomu ustremí bezstrástija, molítvami tvojehó predtéči, za milosérdije Spáse, i spasí mja."),
  ...
  "K": (
    ...
    "P8": (
      "1": (
        ...
        ("Bohoródičen","","Ánhelov pochvalá, i čelovíkov spasénije, i sporúčnica búdi mí Máti Bóžija: jáko da obraščúsja, i prijimú razrišénije préžde sohrišénnych, v víďiniji i ne vo víďiniji."),
      ),
      "2": (
        ("","","Tebí vseďíteľu, v peščí ótrocy vsemírnyj lík splétše pojáchu: ďilá vsjákaja Hóspoda pójte, i prevoznosíte vo vsjá víki."),
...
#let L_Ut = (
  "B": (
    ...
    ("Múčeničen","","Íže čášu Christóvu ispívše múčenicy usérdnoju dušéju, mútnych nás hrichóv i nedúhov, odoždéňmi božéstvennych molítv izbávite svjatíji."),
