...
#let P_Po = (
  "1": (
    ...
    ("","","Íže bezstrástno préžde vík ot Otcá roždénnaho, prečístaja, v posľídňaja dní vo utróbi nosjášči Sýna, rodilá jesí suhúba, Bóha i čelovíka."),
  ...
  "K": (
    "P1": (
      "1": (
        ...
        ("Múčeničen","","Íže krovéj hlubinóju faraóna mýslennaho udavívše inohdá, čestníji velikomúčenicy, k zemlí obitovánija nebésňij preidóste, Christá slávjašče."),
    ...
    "P3": (
      ...
      "2": (
        ("","","Ňísť svját, jákože tý Hóspodi, Bóže mój, voznesýj róh vírnych tvojích bláže, i utverdívyj nás na kámeni ispovídanija tvojehó."),
        ("","","Íže vsjákoje slovésnoje jestestvó, ot ne súščich choťínijem soďílavšeje, trisvjatými hlásy pojétsja v trí líca, i slavoslóvitsja vírno."),
        ("","","Íže vsjákoje slovésnoje jestestvó, ot ne súščich choťínijem soďílavšeje, trisvjatými hlásy pojétsja v trí líca, i slavoslóvitsja vírno."),
    ...
    "P5": (
      "1": (
        ...
        ("","","Íže ot Jesséjova kórene izrastýj, Christé, izsuší prozjabénija strastéj mojích, vsaždája vo mňí strách tvój."),
