#let V_Ut = (
  "HV": (
    ...
    ("","","Íže máterneje neplódstvo, i ótčeje bezhlásije razrišívyj roždestvóm tvojím, bezplódstvije razriší bezčádnaho mojehó sérdca: vsjáko že bezslovésije duší otimí vskóri, Slóvu bo hlás sýj, vozhlašájušč pokajánije, jéže spodóbi mjá sijé soveršáti vsehdá, ot Bóha udalívšahosja ľínosti rádi, Christóv Krestíteľu."),
...
#let P_Ut = (
  ...
  "3": (
    ...
    ("","","Maríje Máti Bóžija, spasénija dvéri, jéjuže prójde jedín íže vsích tvoréc, pokajánija nýňi božéstvennyja dvéri otvérzi mí prečístaja."),
    ...
    ("","","Maríje Máti Bóžija, prosvití dúšu mojú pomračénuju ľúťi mnóhimi hrichí, i strilóju lukávaho ujázvlenuju, i iznemóhšuju."),
  ),
  "4": (
  ...
  "5": (
    ...
    ("","","Oskvernén pómyslom i okaľán mnóhimi padéňmi, Máti Bóžija, ťá moľú jedína neskvérnaja, uščédri i spasí mja chodátajstvom tvojím."),
...
#let U_Ut = (
  ...
  "S3": (
    ...
    ("Bohoródičen","","Íže préžde vík ot Otcá bez mátere, róždšahosja Sýna i Slóva Bóžija, i v posľídňaja ľíta rodilá jesí voploščénna ot čístych krovéj tvojích, Bohorodíteľnice, kromí múža, jehóže molí, darováti nám hrichóv proščénije préžde koncá."),
  ),
  "K": (
    "P1": (
      "1": (
      ...
      "2": (
        ...
        ("","","Ánhel božéstvennyj tvojé roždestvó, ánhele Bóžij, predvozviščájet Otcú: s nímže nás pomjaní, jéže v déň súdnyj obristí nám mílosť, svjatýj Predtéče."),
...
#let L_Ut = (
  "B": (
    ...
    ("","","Íže proróki proslavľájemyj Bóh v Tróici, prósťij že i neslijánňij, Predtéči moľbámi spasí mja."),
