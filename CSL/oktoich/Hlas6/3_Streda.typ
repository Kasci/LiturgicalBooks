...
#let P = (
  ...
  "4": (
    ...
    ("","","Ánheľstiji čínove, i vójinstva nebésnych síl tvojehó Sýna užasájutsja deržávy, čístaja: nýňi že áz otčájavsja, bezstrášijem oderžím jésm."),
...
#let U = (
  ...
  "K": (
    ...
    "P5": (
      ...
      "2": (
        ("","","Bóžijim svítom tvojím bláže, útreňujuščich tí dúšy ľubóviju ozarí moľúsja, ťá víďiti Slóve Bóžij, ístinnaho Bóha, ot mráka hrichóvnaho vzyvájušča."),
        ("","","Íže slóvom vsjá sozdávyj, i múdrym prómyslom Hospóď okormľája jedín, jákože chóščet, blahoutróbijem sozdavájetsja iz tebé prečístaja, i plóť neskazánno byvájet."),
    ...
    "P7": (
      "1": (
        ...
        ("Bohoródičen","","Íže sýj neizmínen Božestvóm, izminíl jesí povíšen na kresťí tvár vsjú, Ďíva hlahólaše Sýnu: i zrjášči sijá plákaše, divjáščisja mnóhomu tvojemú dolhoterpíniju."),
      ),
      "2": (
        ("","","Rosodáteľnu úbo péšč soďíla ánhel, prepodóbnym otrokóm, chaldéji že opaľájuščeje veľínije Bóžije, mučíteľa uviščá vopíti: blahoslovén jesí Bóže otéc nášich."),
    ...
    "P8": (
      "1": (
        ...
        ("Múčeničen","","Chrámy Dúcha živáho javístesja múčenicy, chrámy ídoľskija nizložíste, i k chrámu nebésnomu vzjáti býste, pisnoslóvjašče Christá vo víki."),
  ...
  "CH": (
    ...
    ("","","Íže krestóm ohraždájemi, vrahú protivľájemsja, ne bojáščesja kóznej jehó i lájanija: jáko bo hórdyj uprazdnísja, i poprán býsť síloju na drévi prihvoždénnaho Christá."),
    ...
    ("Krestobohoródičen","Vsjú otložívše","Áhnca svojehó, áhnica neskvérnaja drévle i neporóčnaja Vladýčica, na drévi krestňim jáko uzrí Máterski vosklicáše, i divjáščisja vopijáše: čádo sladčájšeje, čtó zrínije sijé nóvoje i preslávnoje? Káko sónm bezblahodátnyj sudíšču Pilátovu predadé ťa, i osuždájet na smérť životá vsjáčeskich? No vospiváju tvojé neizrečénnoje Slóve, snizchoždénije."),
  ),
)
