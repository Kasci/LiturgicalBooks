...
#let P_Ut = (
  "1": (
    ...
    ("", "", "Pribížišče i spasénija hráde, vsí vírno mólim ťá, Maríje Máti Bóžija, i míli ďíjemsja tépľi: prijimí moľbý náša tvojích vírnych ráb, i razriší vsjá ný ot prehrišénij osuždénija."),
  ),
  "3": (
  ...
  "S": (
    ("", "Milosérdija súšči", "Duší mojejá ľínosť ľútuju, i sérdca mojehó prenemohánije, Máti Bóžija vozzrívši, iscilí molítvami tvojími, i spasénnych mjá části spodóbi, izbavľájušči mjá ťmý i mučénija, jáko jedína upovánije mojé i uťišénije."),
  ),
  "7": (
    ...
    ("", "", "Íže préžde Hedeón predvistvújet tebé čístaja, božéstvennoje roždestvó jávi: okrín prinošájet ispólnen vodý ot ocyždénija runóvnaho: vés bo v ťá božéstvenno vselísja, prečístaja: blahoslovén plód tvojehó čréva čístaja."),
  ...
  "9": (
    ...
    ("", "", "Svít ťá čistotý, i žézl ďívstva, i Máter Bóžiju, Bohoľípno v písnech pojúšče Bohoródice, so hlásom chvalénija mólimsja tí: v ďívstvi utverdí nás, i v čistoťí sochraní."),
...
#let U_Ut = (
  ...
  "K": (
    "?": (
      "Kanón umilénija ko Hóspodu nášemu Iisúsu Christú i svjatým múčenkom",
    ...
    "P1": (
      "1": (
        ...
        ("Múčeničen", "", "Íže mučénija óhň preterpívše, božéstvennym orošénijem strastotérpcy Christóvy, ohňá hejénny izbávite mjá, v strastéch ľútych sležáščaho."),
    ...
    "P3": (
      "1": (
        ...
        ("Múčeničen", "", "Íže strásti Christóvy podražávše dóbri, božéstvennymi óbrazy strastotérpcy Christóvy, duší mojejá ľútyja strásti iscilíte."),
    ...
    "P7": (
      ...
      "2": (
        ...
        ("", "", "Íže míru vzémľuščaho hrích áhnca Bóžija, Predtéče propovídav, tohó molí ot kózlišč části javíti mjá čúžda, i desným jehó ovcám i mené sočetáti, slávne."),
