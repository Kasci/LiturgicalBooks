  ...
  "K": (
    ...
    "P4": (
      "1": (
        ...
        ("Bohoródičen", "", "Íže drévle iz Otcá neroždénna Sýn roždéjsja, roždestvó imí ľítnoje, iz tebé Ďívo voplóščsja, ľítnuju bráň zemnoródnych otjáti choťá blahoutróbnyj, íže dnéj i ľít prevýše sýj."),
      ),
      "2": (
        ("", "", "Hóru ťá blahodátiju Bóžijeju priosinénnuju, prozorlívyma Avvakúm usmotrív očíma, iz tebé izýti Izráilevu provozhlašáše svjatómu, vo spasénije náše i obnovlénije."),
...
#let L_Po = (
  "B": (
    ...
    ("", "", "Ánhel tvojích číny v molénije privódim tí Christé, spasí, uščédri nás ťími, jáko prebláh, vsjá prezirájaj náša, jáže v víďiniji i ne v víďiniji, prehrišénija."),
