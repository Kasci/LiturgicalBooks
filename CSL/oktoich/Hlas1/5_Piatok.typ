...
#let U = (
  ...
  "S2": (
    ...
    ("", "", "Íže drévle Adáma ot pérsti sozdávyj, brénnoju rukóju zaušén býv ščédre, i raspjátije preterpíl jesí, poruhánija že i rány. O čudesé! o mnóhaho dolhoterpínija tvojehó! Sláva Hóspodi živonósnym tvojím strastém, ímiže nás spásl jesí."),
  ...
  "K": (
    "P1": (
      "1": (
        ...
        ("Múčeničen", "", "Íže strástém Christóvym upodóbľšesja dóblestvenňi, strásti isciľivájete zemných, rukoďíjstvijem tájnym, i slóvom prohónite dúchi, svjatíji múčenicy."),
    ...
    "P6": (
      "1": (
        ...
        ("", "", "Íže čésti vsjákija prevýšši, bezčéstije preterpíl jesí Christé, na kresťí vozdvížen, čelovíki počestí choťá."),
    ...
    "P8": (
      "1": (
        ...
        ("Múčeničen", "", "Íže bezplótnym sožítelije, Christóvy vójini, krestóm jáko broňámi obolčéni, k soprotivobórcu opolčíšasja, i tohó krásnymi nohámi popráša."),
...
#let L = (
  "B": (
    ...
    ("Múčeničen", "", "Íže strástém upodóbľšesja, vóleju postradávšemu plótiju, múčenicy slávniji, prísno strásti isciľájete neiscíľnyja, nedúhi že othónite ot čelovík síloju duchóvnoju."),
    ...
    ("", "", "Na kresťí ťa prihvoždéna, jáko uzrí Christé Bóže, jáže tebé róždšaja plótiju, pláčušči viščáše: čtó ti vozdadé, o Sýne mój, jevréjskij sobór zakonoprestúpnyj?"),
  )
)