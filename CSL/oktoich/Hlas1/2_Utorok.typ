#let V_Ut = (
  "HV": (
    ...
    ("Bohoródičen",	"",	"Áhnca, míra vsehó vzémľuščaho hrichí, jehóže prevelíkij Predtéča vsím propovída, s ním Ďívo molí, kózlišč části javíti mjá čúžda v čás súdnyj, i ovcám desným jehó sočtáti mené nedostójnaho."),
  ),
  "S": (
    ...
    ("Bohoródičen",	"",	"Ďívo vsepítaja, júže v tebí tájnu Moiséj proróčeskima víďi očíma, kupinú horjášču i neopaľájemu: Božestvá bo óhň utróbu tvojú čístaja, ne opalí. Ťímže mólim ťá jáko Máter Bóha nášeho, mír isprosíti mírovi, i véliju mílosť.")
  ),
)
...
#let U_Ut = (
  ...
  "S3": (
    ...
    ("", "", "Íže drévle strujámi Jordánskimi krestívyj, Joánne, očiščénije vsehó míra, mnóhimi mjá pohružájema prehrišéňmi vosťahní i omýj ot vsjákija skvérny, čelovikoľúbca vsehdá moľá, jáko chodátaj blahoprijáten."),
  ...
  "K": (
    ...
    "P6": (
      ...
      "2": (
        ("", "", "Proróka Jónu podražája, vopijú: živót mój bláže svobodí iz tlí: i spasí mja Spáse míra, zovúšča: sláva tebí."),
        ("", "", "Íže pokajánije na zemlí propovídavyj Krestíteľu, pokajánija mí putí nastavľájuščija mjá k svítu pokaží, i ot própasti prélesti izbávi."),
        ...
        ("Bohoródičen", "", "Máter Bóžiju i dóbruju v ženách, moľú ťa priľížno, ne prézri mené čístaja, no uščédri, i ot vsjákaho vréda cíla sobľudí."),
      ),
    ),
    "P7": (
      "1": (
