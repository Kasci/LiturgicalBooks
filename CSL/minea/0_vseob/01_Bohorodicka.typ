...
#let U = (
    "K": (
        "P1": ("Vodu prošéd jáko súšu, i Jegípetskaho zla izbižáv Israilfánin vopijáše: Izbávitelu Bohu nášemu poím."),
        "P3": ("Nebésnaho krúha verchotvórče Hóspodi, i cerkvé Ziždítelu, Ty mené utverdí v lubví Tvojéj, želánij kráju, i vírnych utverždénije, jedine čelovikolúbče."),
        "P4": ("Uslýšach Hóspodi smotrénija Tvojehó táinstvo, razumích dilá Tvojá, i proslávich Tvojé božestvó."),
        "P5": ("Prosvití nas povelínii Tvoími Hóspodi, i mýščeju Tvojéju vysókoju, Tvoj mir podážď nam, jedine čelovikolúbče."),
        "P6": ("Molítvu prolijú k Hóspodu, i Tomú vozviščú pečáli mojá, i jáko zol dušá mojá ispólnisja, i život moj ádu priblížisja i moľúsja jáko Jóna: ot tli Bóže vozvedí mja."),
        "P7": ("Ot Judéi došédše ótrocy v Vavilóňi inohdá víroju trójčeskoju plámeň péščnyj popráša pojúšče: Otcév Bóže blahoslovén jesí."),
        "P8": ("Carjá Nebésnaho, Jehóže pojút vói Anhelstii, chválite, i prevoznosíte vo vsjá víki."),
        "P9": ("Voístinnu Bohoródicu ťa ispovídujem, spasénii tobóju Ďívo čístaja, s bezplónymi líki ťa veličájušče.")
    )
)